    ...
    addNewRow() {
      ...
      this.donatebookdetails["email"] = this.bookForm.value.email
       ...
       addNewbookRecord(){
        ...
        const userid = JSON.parse(String(localStorage.getItem('userData'))).userid
      ...
      view() {
        ...
        this.httprequest.postRequestToBackend('/api/books/view',req).subscribe((res) =>{
          console.log("response ===>",res);
        ...
        deleteItem(record:any): void {
          const userid = JSON.parse(String(localStorage.getItem('userData'))).userid
          const req= {
            //uniqueId:this.deleteItem=this.donatebookdetails.books[index] 
            sno:record.sno,
            userid : userid,
         };
  
          this.httprequest.deleteRequestToBackend('/api/books/delete',req).subscribe((res) =>{
            console.log("response ===>",res);
            // localStorage.setItem('userData',JSON.stringify(res.data))
           })
        }
